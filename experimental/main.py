...
if __name__ == '__main__':
    params = [['momentum', 0.5, 1.5, False], ['weight_decay', 0.000005, 0.0005, False]]
    ...
    hb = Hyperband(model=SimpleCNN(num_classes=10, color=True),hyperband=False, param=params, ds_name='CIFAR10', max_iter = 81, eta = 3)
    hb.tune()